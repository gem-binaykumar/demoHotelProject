...
class BookingServiceTest {
    ...
    @Test
    public void testUpdateBookingDetails() throws MessagingException {
        BookingDetails bookingDetails = createBookingDetails();
    ...
    @Test
    public void testGetAllBookingDetails() throws MessagingException {
    ...
    @Test
    public void testGetBookingDetailsById() throws MessagingException {
        Long id = 1000L;
        BookingDetails bookingDetails = createBookingDetails();
    ...
    private BookingDetails createBookingDetails() throws MessagingException {
